...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const scenes = {
    ...
    chess: {
      ...
      content: {
        ...
        achievements: portfolioData.chess.achievements,
        skills: portfolioData.chess.skills
      }
    },
    experience: {
      ...
      content: {
        ...
        timeline: portfolioData.experience.roles
      }
    },
    competitions: {
  ...
  function updateProjectDescription() {
    const total = (scenes.projects.content.gamedevProjects?.length || 0) + 
                  (scenes.projects.content.softwareWebProjects?.length || 0);
        ...
        if (!achievement.unlocked) {
          switch (achievement.id) {
            ...
            case "artifactCollector":
              const projectCount = (scenes.projects.content.gamedevProjects?.length || 0) + 
                                   (scenes.projects.content.softwareWebProjects?.length || 0);
